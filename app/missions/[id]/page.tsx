...
export default function MissionDetailPage() {
  ...
  const submitComment = async () => {
    ...
    try {
      ...
      setSubmitting(prev => ({ ...prev, [commentModal.submissionId + 'comment']: false }))
    }
  }
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-slate-900/70 backdrop-blur-md border border-slate-800 rounded-2xl p-6 hover:border-emerald-500/30 transition-all">
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className="text-xs text-gray-500 bg-slate-800/50 px-3 py-1 rounded-full">{mission.category}</span>
                </div>
              ...
              <div className="bg-slate-900/70 backdrop-blur-md border border-slate-800 rounded-2xl p-4 hover:border-emerald-500/30 transition-all group">
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-violet-500/20 to-fuchsia-500/20 flex items-center justify-center border border-violet-500/20 group-hover:scale-110 transition-transform">
                      <TrendingUp size={24} className="text-violet-400" />
                    </div>
                    <div>
                      <h3 className="text-white font-bold group-hover:text-violet-400 transition-colors">View Leaderboard</h3>
                        ...
                        <div key={sub.id} className="bg-slate-950/50 rounded-2xl border border-slate-800 overflow-hidden hover:border-slate-700 transition-all">
                          ...
                          <div className="p-4 border-b border-slate-800">
                            ...
                            <a 
                              ...
                              target="_blank" 
                              rel="noopener noreferrer"
                              className="flex items-center gap-2 text-sm text-gray-400 hover:text-emerald-400 transition-colors bg-slate-900/50 p-3 rounded-lg border border-slate-800 hover:border-emerald-500/30"
                            >
                              <LinkIcon size={14} />
                                ...
                                <button 
                                  ...
                                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all active:scale-95 disabled:opacity-50 ${
                                    hasLiked 
                                      ...
                                      : 'bg-slate-800 text-gray-400 hover:bg-red-500/10 hover:text-red-400 border border-transparent hover:border-red-500/30'
                                  }`}
                                >
                                ...
                                <button 
                                  ...
                                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all active:scale-95 disabled:opacity-50 ${
                                    hasCommented 
                                      ...
                                      : 'bg-slate-800 text-gray-400 hover:bg-blue-500/10 hover:text-blue-400 border border-transparent hover:border-blue-500/30'
                                  }`}
                                >
                                ...
                                <button 
                                  ...
                                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all active:scale-95 disabled:opacity-50 ${
                                    hasShared 
                                      ...
                                      : 'bg-slate-800 text-gray-400 hover:bg-green-500/10 hover:text-green-400 border border-transparent hover:border-green-500/30'
                                  }`}
                                >
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 w-full max-w-md shadow-2xl">
            ...
            <textarea
              ...
              className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-emerald-500/50 resize-none mb-4 min-h-[100px]"
            />
            <div className="flex gap-3">
              <button
                onClick={() => setCommentModal({ open: false, submissionId: null })}
                className="flex-1 py-3 bg-slate-800 border border-slate-700 text-gray-300 rounded-xl font-semibold hover:bg-slate-700 transition-all"
              >
                Cancel
              </button>
              <button
                onClick={submitComment}
                disabled={!commentText.trim() || submitting[commentModal.submissionId + 'comment']}
                className="flex-1 py-3 bg-emerald-500 text-slate-950 rounded-xl font-semibold hover:bg-emerald-400 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {submitting[commentModal.submissionId + 'comment'] ? (
                  <>
