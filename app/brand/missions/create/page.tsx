...
import { Target, Plus, ImageIcon, Crown, CheckCircle, Sparkles, Loader2, Star, Shield } from 'lucide-react'
...
export default function CreateMission() {
  ...
  const handleSubmit = async () => {
    ...
    if (!userBadge) {
      toast.error('Please purchase Official Brand badge first!')
      return
    }
  ...
  // Yellow/Gold Badge Box Component - RIGHT SIDE
  const BadgeBox = () => {
    if (checkingBadge) {
      return (
      ...
      return (
        <div className="bg-gradient-to-br from-yellow-500/10 via-yellow-600/10 to-yellow-700/10 border border-yellow-500/30 rounded-2xl p-6 h-fit">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center shadow-lg shadow-yellow-500/20">
    ...
    // NOT PURCHASED - Show Purchase Box
    return (
      <div className="bg-brand-card border border-brand-border rounded-2xl p-6 h-fit">
        <div className="text-center mb-6">
          <div className="w-20 h-20 mx-auto rounded-2xl bg-gradient-to-br from-yellow-400 via-yellow-500 to-yellow-600 flex items-center justify-center shadow-lg shadow-yellow-500/20 mb-4">
            <Crown size={36} className="text-white" />
          </div>
          <h3 className="text-xl font-bold text-white mb-1">Official Brand</h3>
          <p className="text-xs text-gray-400">1 Year Access</p>
        </div>
        ...
        <p className="text-xs text-gray-500 text-center mt-4">
          Secure payment via Solana • No additional fees
        </p>
      </div>
    )
  }
        ...
        <main className="flex-1 p-6 lg:p-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              {/* RIGHT COLUMN - Yellow Badge Box Only */}
