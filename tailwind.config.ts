  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-gradient': 'radial-gradient(ellipse at top left, rgba(0,255,136,0.15) 0%, transparent 50%), radial-gradient(ellipse at bottom right, rgba(155,89,255,0.15) 0%, transparent 50%)',
      },
    },
  },
  plugins: [],
